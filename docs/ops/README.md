...
- **You currently log in via legacy direct `AdministratorAccess` assignments**, but the CDK target now defines group-based management, CAMPPS nonprod, production read-only, and production break-glass access. Migration is a P2 backlog item. See [02-identity-and-access.md](02-identity-and-access.md).
